...
use crate::{
    ...
    config_types::{
        ...
        HttpSinkConfigHttp, HttpTlsConfigHttp, KafkaSecurityConfigHttp,
        KafkaSinkConfigHttp, LockoutConfigHttp, LoggingHttp, LoggingOutputHttp,
        ...
        SinkConfigEntryHttp, SinkConfigHttp, SinkServerHttp, SinkTargetHttp,

use bridge::{
    ...
    AveConfig as AveConfigBridge, Logging as LoggingBridge,
...
impl From<ConfigBridge> for Config {
    fn from(value: ConfigBridge) -> Self {
        Self {
            ave_config: AveConfig::from(value.ave_config),
...
impl From<AveConfigBridge> for AveConfig {
    fn from(value: AveConfigBridge) -> Self {
        Self {
            keypair_algorithm: value.keypair_algorithm.to_string(),
            hash_algorithm: value.hash_algorithm.to_string(),
